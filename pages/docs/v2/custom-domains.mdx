...
export const meta = {
  ...
  lastEdited: '2020-05-18T18:05:11.000Z'
}
...
Once on the **Domains** tab, click on the domain for which you want to view the Advanced Settings page.

<Image
  src={`${process.env.ASSETS}/docs/custom-domains/domains-list-2.png`}
  width={2036 / 2}
  height={830 / 2}
  shadow
/>
<Caption>Selecting the domain to go to the Advanced Settings page.</Caption>

### Step 2: Add DNS record

Once on the Advanced Settings page, click on the **Add** button to show the DNS records form.
...
<Image
  ...
  shadow
/>
<Caption>Clicking the <b>Add</b> button to show the DNS records form.</Caption>

Using the form, you can choose to add between one of the following DNS record types:
